...
<head>
    ...
    <title> Mass Marriage || Nimitta NGO</title>
            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span>/</span></li>
                        <li class="active">Mass Marriage</li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="event-details__img">
                            <img src="<?php echo base_url();?>assets/images/gallery/nimitta-mass-marriage.JPG" alt="">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="event-details__bottom-left">
                                <div class="event-details__bottom-content">
                                    ...
                                    <p class="event-details__text-1">In 2016-17, we identified a widespread women specific issue and a cause accelerating the poverty, leading to many other social problems, the tradition of Dhuku. As a result, we conducted our first mass marriage of live-in 21 couples in Khunti . Since then, we have conducted similar mass-marriage ceremonies every year. As of 2020-21, we have married off more than 600 couples and improved the life of many women and children. </p>
                                </div>
                            </div>
                        </div>
