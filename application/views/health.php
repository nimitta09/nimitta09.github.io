...
<head>
    ...
    <title> Health || Nimitta NGO</title>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="event-details__img">
                            <img src="<?php echo base_url();?>assets/images/gallery/conv_h_5.webp" alt="">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="event-details__bottom-left">
                                <div class="event-details__bottom-content">
                                    ...
                                    <p class="event-details__text-1">With support of ONGC, we procured kits for Sahiyya and ANM in the blocks of Karra, Arki, and Khunti in the Khunti district. This resulted in a total of 450 kits for Sahiyya and 150 kits for ANMs of these blocks. Kits went above and beyond the specified norms of the district and were targeted at the needs of their users and to handle stresses of the environment.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-5">
                            <div class="event-details__img">
                            <img src="<?php echo base_url();?>assets/images/gallery/conv_h_4.webp" alt="">
                        </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="item">
                        ...
                        <div class="events__single">
                            <div class="events__img">
                                <img src="assets/images/gallery/conv_h_3.webp" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="events__single">
                            <div class="events__img">
                                <img src="assets/images/gallery/conv_h_2.webp" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="events__single">
                            <div class="events__img">
                                <img src="assets/images/gallery/conv_h_1.webp" alt="">
                            </div>
                        </div>
                    </div>
                </div>
