...
<head>
    ...
    <title> Nimitta | NGO | Mass-Marriage | Health | Covid Relief | Water & Sanitation | Birth Registration</title>
    <!-- favicons Icons -->
...
<body>
    ...
    "autoplay": {
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image: url(assets/images/backgrounds/dhuku-nimitta.png); height: 750px;">
                        </div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7">
                                    <div class="main-slider__content">
                                        <h2>Dhuku mass marriage ceremony</h2>
                                        <p>One of our many Dhuku mass marriages, this photo is from 2019 when we married people from Khunti, Kanke, and Ranchi</p>
                                        <a href="<?php echo base_url(); ?>about" class="thm-btn">Discover More</a>
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image: url(assets/images/backgrounds/nimitta-education.jpg); height: 750px;">
                        </div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image: url(assets/images/backgrounds/marriage.png); height: 750px;">
                        </div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7">
                                    <div class="main-slider__content">
                                        <h2>A Happy couple, just having been married</h2>
                                        <p>We are here to support you every step of the way</p>
                                        <a href="<?php echo base_url(); ?>about" class="thm-btn">Discover More</a>
                                        <div class="main-slider-shape-1"><img
                                                src="assets/images/shapes/main-slider-shape-1.png" class="float-bob-x"
        ...
        <section class="we-believe">
            ...
            <div class="container">
                <div class="section-title text-center">
                    <span class="section-title__tagline">welcome to Nimitta</span>
                    <h2 class="section-title__title">We Believe that We can Change <br> more Lives with you</h2>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <ul class="list-unstyled we-believe__list">
                            <li class="we-believe__single wow fadeInUp" data-wow-delay="100ms">
                                ...
                                <h3 class="we-believe__title"><a href="contact.html">Support</a></h3>
                            ...
                            <li class="we-believe__single wow fadeInUp" data-wow-delay="300ms">
                                ...
                                <h3 class="we-believe__title"><a href="volunteers.html">Volunteers</a></h3>
                                <!-- <p class="we-believe__text">Lorem ipsum is simply free text available in the market
                                    wesbites.</p> -->
                            </li>
                        ...
                        <div class="welcome-one__left">
                            <div class="welcome-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="welcome-one__img">
                                    <img src="assets/images/resources/nimitta-marriage.png" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="welcome-one__right">
                            <div class="section-title text-left">
                                <span class="section-title__tagline">Welcome to Nimitta</span>
                                <h2 class="section-title__title">Our goal is to bring forth people from diverse sections of society for common human interest developmental goals.</h2>
                            </div>
                            <p class="welcome-one__text-1">NIMITTA is strong both in advocacy and action fronts.</p>
        ...
        <section class="causes-one">
            <div class="container">
                <div class="section-title text-left">
                    <span class="section-title__tagline">Help during Covid-19 pandemic</span>
                    <h2 class="section-title__title">Covid Relief</h2>
                        ...
                        <div class="causes-one__carousel owl-theme owl-carousel">
                            ...
                            <div class="causes-one__single">
                                <div class="causes-one__img">
                                    <img src="<?php echo base_url();?>assets/images/covid/conv_c_3.webp" alt="">
                                </div>
                            </div>
                            <!--Cause One Single-->
                            <div class="causes-one__single causes-one__single-2">
                                <div class="causes-one__img">
                                    <img src="<?php echo base_url();?>assets/images/covid/conv_c_10.webp" alt="">
                            ...
                            <div class="causes-one__single causes-one__single-3">
                                <div class="causes-one__img">
                                    <img src="<?php echo base_url();?>assets/images/covid/conv_c_11.webp" alt="">
                                   
                                </div>
                            </div>
                            <div class="causes-one__single causes-one__single-3">
                                <div class="causes-one__img">
                                    <img src="<?php echo base_url();?>assets/images/covid/conv_c_12.webp" alt="">
                                   
                                </div>
                            </div>
                            <div class="causes-one__single causes-one__single-3">
                                <div class="causes-one__img">
                                    <img src="<?php echo base_url();?>assets/images/covid/conv_c_13.webp" alt="">
                                   
                                </div>
                            </div>
                            <div class="causes-one__single causes-one__single-3">
                                <div class="causes-one__img">
                                    <img src="<?php echo base_url();?>assets/images/covid/conv_c_15.webp" alt="">
                                   
                                </div>
                            </div>
                            <div class="causes-one__single causes-one__single-3">
                                <div class="causes-one__img">
                                    <img src="<?php echo base_url();?>assets/images/covid/conv_c_16.webp" alt="">
        ...
        <section class="two-boxes">
            <div class="container">
                <div class="section-title text-center">
                    <h2 class="section-title__title">Our Life Changing Initiatives</h2>
                </div>
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        ...
                        <div class="two-boxes__single wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <div class="two-boxes__single-bg"
                                style="background-image: url(assets/images/gallery/nimitta-marriage-2.JPG);">
                            </div>
                            <div class="two-boxes__content">
                                <h3 class="two-boxes__title">Gender : Mass-Marriage</h3>
                                <p class="two-boxes__text">We identify a widespread women specific issue and a cause accelerating the poverty</p>
                                <a href="<?php echo base_url();?>massmarriage" class="donate-btn"> <i class="fa fa-heart"></i>Know More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        ...
                        <div class="two-boxes__single wow slideInRight" data-wow-delay="100ms"
                            data-wow-duration="2500ms">
                            <div class="two-boxes__single-bg"
                                style="background-image: url(assets/images/gallery/sahiyya-kits.webp);">
                            </div>
                            <div class="two-boxes__content">
                                <h3 class="two-boxes__title">Health</h3>
                                <p class="two-boxes__text"> We work for the needs of ANM workers and Sahiyya to ensure most utility.
                        </p>
                                <a href="<?php echo base_url();?>health" class="donate-btn"> <i class="fa fa-heart"></i>Know More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        ...
                        <div class="two-boxes__single wow slideInLeft" data-wow-delay="100ms"
                            data-wow-duration="2500ms">
                            <div class="two-boxes__single-bg"
                                style="background-image: url(assets/images/gallery/nimitta-sanitation.JPG">
                            </div>
                            <div class="two-boxes__content">
                                <h3 class="two-boxes__title">Water & Sanitation</h3>
                                <p class="two-boxes__text">Under Neer-Nirmal Pariyojna, we implemented a World Bank project on water and sanitation.</p>
                                <a href="<?php echo base_url();?>sanitation" class="donate-btn"> <i class="fa fa-heart"></i> Know More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        ...
                        <div class="two-boxes__single wow slideInRight" data-wow-delay="100ms"
                            data-wow-duration="2500ms">
                            <div class="two-boxes__single-bg"
                                style="background-image: url(assets/images/gallery/nimitta.jpg);">
                            </div>
                            <div class="two-boxes__content">
                                <h3 class="two-boxes__title">Birth registration</h3>
                                <p class="two-boxes__text">We carried out 2 days Birth Registration Training Program, funded by UNICEF.</p>
                                <a href="<?php echo base_url();?>birth" class="donate-btn"> <i class="fa fa-heart"></i> Know More</a>
                            </div>
                        </div>
                    </div>
        ...
        <section class="fundraishing">
            <div class="fundraishing-bg-box">
                <div class="fundraishing-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
                    style="background-image: url(assets/images/backgrounds/sanitation-nimitta.jpg);"></div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="fundraishing__inner">
                            <p class="fundraishing__sub-title">We’re Here to Support</p>
                                                    ...
                                                    <ul class="list-unstyled tab-content__inner-list">
                                                        <li>
                                                            ...
                                                            <div class="tab-content__desc">
                                                                ...
                                                                <p class="tab-content__text">Help us change the world by joining us</p>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div
                                                            ...
                                                            <div class="tab-content__desc">
                                                                ...
                                                                <p class="tab-content__text">Join our hand in the development process</p>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="tab-content__inner-right ">
                                                    <div class="tab-content__image">
                                                        <img src="assets/images/backgrounds/inspire.jpg" alt="tab causes">
        ...
        <section class="brand-one">
            ...
            <div class="container">
                <div class="thm-swiper__slider swiper-container" data-swiper-options='{"spaceBetween": 100, "slidesPerView": 5, "autoplay": { "delay": 5000 }, "breakpoints": {
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="assets/images/partners/CCL-nimitta.jpg" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="assets/images/partners/CMPDI.png" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="assets/images/partners/hpcl.png" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="assets/images/partners/nabard-agencies.jpg" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="assets/images/partners/boi.jpg" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="assets/images/partners/union-bank.jpg" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="assets/images/partners/ongc.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="<?php echo base_url(); ?>" aria-label="logo image"><img src="assets/images/nimitta-logo-2.png" alt="" /></a>
            </div>
            <!-- /.logo-box -->
